...
const navItems = [
  ...
  { path: "/volunteer/incidents", label: "Incidents", icon: "📋" },
  { path: "/volunteer/notifications", label: "Notifications", icon: "🔔" },
...
export default function VolunteerLayout({ children }) {
  ...
  const isActive = (path) => {
    if (path === "/volunteer") return location.pathname === "/volunteer";
