...
const navItems = [
  { path: "/security", label: "Dashboard", icon: "🔒" },
  { path: "/security/sos", label: "SOS Alerts", icon: "🚨" },
  { path: "/security/notifications", label: "Notifications", icon: "🔔" },
  { path: "/security/profile", label: "Profile", icon: "👤" },
];
